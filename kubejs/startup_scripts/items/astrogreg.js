StartupEvents.registry('item', event => {
    ...
    const items = [
        ...
        { id: 'netherite_carbon_fibers', name: 'Netherite Fibers', texture: 'nethercarbon/netherite_carbon_fibers'},
        { id: 'netherite_carbon_fiber_mesh', name: 'Netherite Fiber Mesh', texture: 'nethercarbon/netherite_carbon_fiber_mesh'},
        { id: 'netherite_carbon_fiber_plate', name: 'Netherite Fiber Plate', texture: 'nethercarbon/netherite_carbon_fiber_plate'},
    ...
    tiers.forEach(([tier, displayTier]) => { 
