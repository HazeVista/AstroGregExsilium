StartupEvents.registry('item', event => {
    ...
    [
        ...
        ,{tier:"IV",color:"§9"},{tier:"LuV",color:"§d"},{tier:"ZPM",color:"§c"},{tier:"UV",color:"§3"},{tier:"UHV",color:"§4"}].forEach(circuit=>{
            event.create(`${circuit.tier.toLowerCase()}_universal_circuit`)
                .texture(`kubejs:item/star_technology_universal_circuits/${circuit.tier.toLowerCase()}_universal_circuit`)
