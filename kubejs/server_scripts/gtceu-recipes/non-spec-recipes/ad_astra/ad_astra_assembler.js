...
parts('assemble_wheel')
    .itemInputs('2x gtceu:steel_plate', '4x gtceu:steel_rod', 'gtceu:steel_sleeve')
...
parts('assemble_wheel_alt')
    .itemInputs('2x gtceu:steel_plate', '4x gtceu:steel_rod', 'gtceu:steel_sleeve', '8x gtceu:rubber_plate')
    .itemOutputs('ad_astra:wheel')
    .duration(200)
    .circuit(30)
    .EUt(30)
...
parts('assemble_buggy')
    .itemInputs('16x gtceu:steel_plate', '4x gtceu:long_steel_rod', 'gtceu:computer_monitor_cover', '4x ad_astra:wheel', '#gtceu:batteries/lv', 'gtceu:lv_hermetic_casing', 'ad_astra:radio')
...
parts('assemble_basic_fin')
    ...
    .itemOutputs('astrogreg:basic_rocket_fin')
    .duration(200)
    .circuit(30)
    .EUt(30)
    .addMaterialInfo(true)
...
parts('assemble_advanced_fin')
    ...
    .itemOutputs('astrogreg:advanced_rocket_fin')
    .duration(200)
    .circuit(30)
    .EUt(1920)
    .addMaterialInfo(true)
...
parts('assemble_elite_fin')
    ...
    .itemOutputs('astrogreg:elite_rocket_fin')
    .duration(200)
    .circuit(30)
    .EUt(30720)
    .addMaterialInfo(true)
...
parts('assemble_ultimate_fin')
    ...
    .itemOutputs('astrogreg:ultimate_rocket_fin')
    .duration(200)
    .circuit(30)
    .EUt(491520)
    .addMaterialInfo(true)
...
parts('assemble_basic_nose')
    ...
    .itemOutputs('astrogreg:basic_rocket_nose_cone')
    .duration(300)
    .circuit(30)
    .EUt(120)
    .addMaterialInfo(true)
...
parts('assemble_advanced_nose')
    ...
    .itemOutputs('astrogreg:advanced_rocket_nose_cone')
    .duration(300)
    .circuit(30)
    .EUt(1920)
    .addMaterialInfo(true)
...
parts('assemble_elite_cone')
    ...
    .itemOutputs('astrogreg:elite_rocket_nose_cone')
    .duration(300)
    .circuit(30)
    .EUt(30720)
    .addMaterialInfo(true)
...
parts('assemble_ultimate_cone')
    ...
    .itemOutputs('astrogreg:ultimate_rocket_nose_cone')
    .duration(300)
    .circuit(30)
    .EUt(491520)
    .addMaterialInfo(true)
...
parts('assemble_lv_engine')
    ...
    .itemOutputs('astrogreg:lv_rocket_engine')
    .duration(600)
    .circuit(30)
    .EUt(16)
    .addMaterialInfo(true)
...
parts('assemble_mv_engine')
    ...
    .itemOutputs('astrogreg:mv_rocket_engine')
    .duration(600)
    .circuit(30)
    .EUt(64)
    .addMaterialInfo(true)
...
parts('assemble_hv_engine')
    ...
    .itemOutputs('astrogreg:hv_rocket_engine')
    .duration(600)
    .circuit(30)
    .EUt(256)
    .addMaterialInfo(true)
...
parts('assemble_ev_engine')
    ...
    .itemOutputs('astrogreg:ev_rocket_engine')
    .duration(600)
    .circuit(30)
    .EUt(1024)
    .addMaterialInfo(true)
...
parts('assemble_iv_engine')
    ...
    .itemOutputs('astrogreg:iv_rocket_engine')
    .duration(600)
    .circuit(30)
    .EUt(4096)
    .addMaterialInfo(true)
...
parts('solar_panel')
    .itemInputs('gtceu:lv_machine_hull', 'gtceu:long_steel_rod', 'ad_astra:photovoltaic_etrium_cell', '16x gtceu:fine_red_alloy_wire', '2x gtceu:tin_single_cable')
