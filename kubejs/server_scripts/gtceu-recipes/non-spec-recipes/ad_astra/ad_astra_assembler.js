...
parts('assemble_advanced_nose')
    ...
    .itemOutputs('ad_astra:advanced_rocket_nose_cone')
    .duration(300)
    .circuit(30)
    .EUt(1920)
...
parts('assemble_elite_cone')
    ...
    .itemOutputs('ad_astra:elite_rocket_nose_cone')
    .duration(300)
    .circuit(30)
    .EUt(30720)
...
parts('assemble_ultimate_cone')
    ...
    .itemOutputs('ad_astra:ultimate_rocket_nose_cone')
    .duration(300)
    .circuit(30)
    .EUt(491520)
//#endregion
...
parts('assemble_lv_engine')
    .itemInputs('16x gtceu:steel_plate', '4x gtceu:lv_electric_motor', '2x gtceu:long_steel_rod', 'gtceu:steel_frame', 'gtceu:tin_rotor')
    .itemOutputs('ad_astra:lv_rocket_engine')
    .duration(600)
    .circuit(30)
    .EUt(16)
    
parts('assemble_mv_engine')
    .itemInputs('16x gtceu:aluminium_plate', '4x gtceu:mv_electric_motor', '4x gtceu:long_aluminium_rod', 'gtceu:aluminium_frame', 'gtceu:steel_rotor')
    .itemOutputs('ad_astra:mv_rocket_engine')
    .duration(600)
    .circuit(30)
    .EUt(64)

parts('assemble_hv_engine')
    .itemInputs('16x gtceu:stainless_steel_plate', '4x gtceu:hv_electric_motor', '2x gtceu:long_stainless_steel_rod', 'gtceu:stainless_steel_frame', 'gtceu:stainless_steel_rotor')
    .itemOutputs('ad_astra:hv_rocket_engine')
    .duration(600)
    .circuit(30)
    .EUt(256)
    
parts('assemble_ev_engine')
    .itemInputs('16x gtceu:titanium_plate', '4x gtceu:ev_electric_motor', '2x gtceu:long_titanium_rod', 'gtceu:titanium_frame', 'gtceu:titanium_rotor')
    .itemOutputs('ad_astra:ev_rocket_engine')
    .duration(600)
    .circuit(30)
    .EUt(1024)
        
parts('assemble_iv_engine')
    .itemInputs('16x gtceu:tungsten_steel_plate', '4x gtceu:iv_electric_motor', '2x gtceu:long_tungsten_steel_rod', 'gtceu:tungsten_steel_frame', 'gtceu:tungsten_steel_rotor')
    .itemOutputs('ad_astra:iv_rocket_engine')
    .duration(600)
    .circuit(30)
    .EUt(4096)
//#endregion
