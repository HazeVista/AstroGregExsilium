ServerEvents.recipes(event => {
    ...
    const culinaryCutting = [
      ...
      { id: 'chocolate_cake_slice', input: 'createaddition:chocolate_cake', outputs: ['6x farmersdelight:chocolate_cake_slice'], duration: 40, EUt: 2 },
      { id: 'honey_cake_slice', input: 'createaddition:honey_cake', outputs: ['6x farmersdelight:honey_cake_slice'], duration: 40, EUt: 2 },
      { id: 'cooked_mutton_chops', input: 'minecraft:cooked_mutton', outputs: ['2x farmersdelight:cooked_mutton_chops'], duration: 40, EUt: 2 },
      ...
      { id: 'raw_pasta', input: '#forge:dough', outputs: ['farmersdelight:raw_pasta'], duration: 40, EUt: 2 },
      { id: 'kelp_roll_slice', input: 'farmersdelight:kelp_roll', outputs: ['3x farmersdelight:kelp_roll_slice'], duration: 40, EUt: 2 },
      { id: 'pumpkin_slice', input: 'minecraft:pumpkin', outputs: ['4x farmersdelight:pumpkin_slice'], duration: 100, EUt: 2 },
      { id: 'apple_pie_slice', input: 'farmersdelight:apple_pie', outputs: ['6x farmersdelight:apple_pie_slice'], duration: 40, EUt: 2 },
      { id: 'sweet_berry_cheesecake_slice', input: 'farmersdelight:sweet_berry_cheesecake', outputs: ['6x farmersdelight:sweet_berry_cheesecake_slice'], duration: 40, EUt: 2 },
      { id: 'rice', input: 'farmersdelight:rice_panicle', outputs: ['farmersdelight:rice', 'farmersdelight:straw'], duration: 40, EUt: 2 },
      { id: 'chocolate_pie_slice', input: 'farmersdelight:chocolate_pie', outputs: ['6x farmersdelight:chocolate_pie_slice'], duration: 40, EUt: 2 },
      { id: 'mutton_chops', input: 'minecraft:mutton', outputs: ['2x farmersdelight:mutton_chops'], duration: 40, EUt: 2 },
      { id: 'red_mushroom', input: 'farmersdelight:red_mushroom_colony', outputs: ['5x minecraft:red_mushroom'], duration: 40, EUt: 2 },
      ...
      { id: 'bacon', input: 'minecraft:porkchop', outputs: ['2x farmersdelight:bacon'], duration: 40, EUt: 2 },
      { id: 'cabbage_leaf', input: 'farmersdelight:cabbage', outputs: ['2x farmersdelight:cabbage_leaf'], duration: 40, EUt: 2 },
