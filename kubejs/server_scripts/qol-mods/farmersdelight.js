ServerEvents.recipes(event => {
  ...
  event.replaceOutput('delightful:matcha_milkshake', 'delightful:matcha_milkshake',
     '1x delightful:matcha_milkshake')
  event.replaceOutput('delightful:salmonberry_milkshake', 'delightful:salmonberry_milkshake',
     '1x delightful:salmonberry_milkshake')
  //#endregion
})
