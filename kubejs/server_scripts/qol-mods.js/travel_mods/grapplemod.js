...
function registerGrapplingHookRecipes(event) {
    ...
    event.recipes.kubejs.shaped('grapplemod:grapplinghook', [
        ...
        A: 'gtceu:wrought_iron_drill_head',
    ...
    .modifyResult((craftingGrid, result) => {
        ...
        return result;
    }).id('gtceu:grapplemod/shapeless/grapplinghook');

    //Repair
    event.recipes.kubejs.shapeless(Item.of('grapplemod:grapplinghook').withName(Text.translate("gtceu.grapplemod.repair")), ['grapplemod:grapplinghook', 'gtceu:wrought_iron_dust'])
        .modifyResult((craftingGrid, result) => {
        try {
            let fallbackItem = Item.of("minecraft:air");
    ...
    motorUpgrades.forEach(motorUpgradeType => {
        ...
        shapelessUpgradeRecipe([`gtceu:${motorUpgradeType.electricTier}_electric_motor`], (customization, orig, result) => {
            ...
            return result;
        }, `gtceu.grapplemod.upgrades.motor.${motorUpgradeType.electricTier}`).id(`gtceu:grapplemod/upgrades/motor/${motorUpgradeType.electricTier}`);
        ...
        shapelessUpgradeRecipe([`gtceu:${motorUpgradeType.electricTier}_electric_motor`, '#forge:tools/hammers'], (customization, orig, result) => {
            ...
            return result;
        }, `gtceu.grapplemod.downgrades.motor`)
        ...
        .id(`gtceu:grapplemod/downgrades/motor/${motorUpgradeType.electricTier}`);
    })
    ...
    shapelessUpgradeRecipe(['gtceu:basic_electronic_circuit'], (customization, orig, result) => {
        ...
        return result;
    }, 'gtceu.grapplemod.upgrades.smart_motor').id('gtceu:grapplemod/upgrades/smart_motor');
    ...
    shapelessUpgradeRecipe(['gtceu:sticky_resin'], (customization, orig, result) => {
        ...
        return result;
    }, 'gtceu.grapplemod.upgrades.sticky')
    .id('gtceu:grapplemod/upgrades/sticky')
    ...
    forcefieldUpgrades.forEach(forcefieldUpgradeType => {
        ...
        shapelessUpgradeRecipe([`gtceu:${forcefieldUpgradeType.electricTier}_field_generator`], (customization, orig, result) => {
            ...
            return result;
        }, `gtceu.grapplemod.upgrades.forcefield.${forcefieldUpgradeType.electricTier}`).id(`gtceu:grapplemod/upgrades/forcefield/${forcefieldUpgradeType.electricTier}`);
        ...
        shapelessUpgradeRecipe([`gtceu:${forcefieldUpgradeType.electricTier}_field_generator`, '#forge:tools/hammers'], (customization, orig, result) => {
            ...
            return result;
        }, 'gtceu.grapplemod.downgrades.forcefield')
    ...
    magnetUpgrades.forEach(magnetUpgradeTier => {
        ...
        shapelessUpgradeRecipe([`gtceu:${magnetUpgradeTier.ingotName}`], (customization, orig, result) => {
            ...
            return result;
        }, `gtceu.grapplemod.upgrades.magnet.${magnetUpgradeTier.ingotName}`).id(`gtceu:grapplemod/upgrades/magnet/${magnetUpgradeTier.ingotName}`);
        ...
        shapelessUpgradeRecipe([`gtceu:${magnetUpgradeTier.ingotName}`, '#forge:tools/hammers'], (customization, orig, result) => {
            ...
            return result;
        }, 'gtceu.grapplemod.downgrades.magnet')
            ...
            .id(`gtceu:grapplemod/downgrades/magnet/${magnetUpgradeTier.ingotName}`);
    })
    ...
    shapelessUpgradeRecipe(['gtceu:helium_bucket'], (customization, orig, result) => {
        ...
        return result;
    }, `gtceu.grapplemod.upgrades.gravity.0.5`).id('gtceu:grapplemod/upgrades/gravity/0.5');
    ...
    shapelessUpgradeRecipe(['minecraft:bucket', '#forge:tools/hammers'], (customization, orig, result) => {
        ...
        return result;
    }, 'gtceu.grapplemod.downgrades.gravity.0.5')
    .replaceIngredient('minecraft:bucket', 'gtceu:helium_bucket')
    .id('gtceu:grapplemod/downgrades/gravity/0.5');
    ...
    shapelessUpgradeRecipe(['gtceu:gravitation_engine_unit'], (customization, orig, result) => {
        ...
        return result;
    }, 'gtceu.grapplemod.upgrades.gravity.0').id('gtceu:grapplemod/upgrades/gravity/0');
    ...
    throwUpgrades.forEach(throwUpgradeType => {
        ...
        shapelessUpgradeRecipe([`gtceu:${throwUpgradeType.electricTier}_electric_piston`], (customization, orig, result) => {
            ...
            return result;
        }, `gtceu.grapplemod.upgrades.throwspeed.${throwUpgradeType.electricTier}`).id(`gtceu:grapplemod/upgrades/throwspeed/${throwUpgradeType.electricTier}`);
        ...
        shapelessUpgradeRecipe([`gtceu:${throwUpgradeType.electricTier}_electric_piston`, '#forge:tools/hammers'], (customization, orig, result) => {
            ...
            return result;
        }, 'gtceu.grapplemod.downgrades.throwspeed')
            ...
            .id(`gtceu:grapplemod/downgrades/throwspeed/${throwUpgradeType.electricTier}`);
    ...
    shapedUpgradeRecipe([
        ...
        return result;
    }, 'gtceu.grapplemod.upgrades.vertical_throwing_angle').id('gtceu:grapplemod/upgrades/vertical_throwing_angle');
    ...
    shapedUpgradeRecipe([
        ...
        customization.sneakingverticalthrowangle = customization.verticalthrowangle / 2;
        return result;
    }, 'gtceu.grapplemod.downgrades.vertical_throwing_angle').id('gtceu:grapplemod/downgrades/vertical_throwing_angle')
    ...
    shapedUpgradeRecipe([
        ...
        return result;
    }, 'gtceu.grapplemod.upgrades.angle').kjsMirror(false).id('gtceu:grapplemod/upgrades/angle');
...
ServerEvents.recipes(event => {
    event.shaped('grapplemod:repeller', [
        ...
        C: 'gtceu:rhodium_plated_palladium_rod',
        D: 'gtceu:ev_vanadium_battery'
    })
